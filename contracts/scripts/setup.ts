...
async function main() {
  ...
  let deployed = contract.attach("0x84eA74d481Ee0A5332c457a4d796187F6Ba67fEB");
  let res = await deployed.addCertificateType(
    "Generic",
    JSON.stringify({
      iconUrl: "https://cdn-icons-png.flaticon.com/512/1/1700.png",
    }),
    {
  ...
  res = await deployed.addCertificateType(
    "Aadhaar",
    JSON.stringify({
      iconUrl:
        "https://upload.wikimedia.org/wikipedia/en/thumb/c/cf/Aadhaar_Logo.svg/500px-Aadhaar_Logo.svg.png",
    }),
    {
      // value: ethers.utils.parseEther("0.00004"),
      // gasPrice: 8000000000,
  ...
  res = await deployed.addCertificate(
    certTypeId,
    "Person1",
    JSON.stringify({
      type: "Skill",
